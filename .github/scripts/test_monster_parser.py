...
DECLARED_GAPS = {
    ...
    "name_en",
    # Ссылки на заклинания резолвятся по названию: RU-название в черте монстра не всегда
    # совпадает с названием заклинания в главе, и нерезолвленное отбрасывается (#274).
    "spells",
}
by_source = {}
