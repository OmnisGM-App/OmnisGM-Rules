...
«лазанье» и «лазание» — две живые формы расщеплённого корпуса 5.2 (30 строк скорости
против 23, в главе монстров поровну по 22, см. #270):
...
# Корпус RU 5.2 расщеплён по слову (#270): скорость с «лазанье» пишут 30 строк, с
# «лазание» — 23 (в главе монстров по 22), — поэтому в словаре живут обе формы, и
