...
# Строки взяты из корпуса БАЙТ В БАЙТ (`13_Animals.md`): синтетическая форма «лазание»
# закрепляла слово, которого в русском тексте нет, и climb уезжал пустым у 30 блоков.
SPEEDS = [
