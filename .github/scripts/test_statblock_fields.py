...
SIDEBAR_CASES = [
    ("верная пара", "Medium Undead, Neutral Evil", "Средняя Нежить, Нейтрально-злой", 0),
    ("подменён тип", "Medium Undead, Neutral Evil",
     "Средняя Аберрация, Нейтрально-злой", 1),
    ...
    ("тип со строчной", "Medium Undead, Neutral Evil",
     "Средняя нежить, Нейтрально-злой", 2),
    ("постороннее слово в типе", "Medium Undead, Neutral Evil",
     "Средняя Нежить-мутант, Нейтрально-злой", 2),
    ("мусор конвертации", "Medium Undead, Neutral Evil",
     "Средняя Нежить 12, Нейтрально-злой", 1),
    ("подменено мировоззрение", "Medium Undead, Neutral Evil",
     "Средняя Нежить, Принципиально-добрый", 1),
    ("форма мировоззрения не как в главе", "Medium Undead, Neutral Evil",
     "Средняя Нежить, нейтрально-злой", 1),
    ("мировоззрения нет в главе", "Medium Undead, Unaligned",
     "Средняя Нежить, Без мировоззрения", 1),
    ("род размера", "Medium Undead, Neutral Evil",
     "Средний Нежить, Нейтрально-злой", 1),
    ("регистр размера", "Medium Undead, Neutral Evil",
     "средняя Нежить, Нейтрально-злой", 2),
    ("нет запятой", "Medium Undead, Neutral Evil", "Средняя Нежить Нейтрально-злой", 1),
    ("подменена связка", "Large Celestial, Fey, or Fiend (Your Choice), Neutral",
     "Большой Небожитель, Фея и Исчадие (на ваш выбор), нейтральный", 1),
    ("снят один тип", "Large Celestial, Fey, or Fiend (Your Choice), Neutral",
     "Большой Небожитель или Исчадие (на ваш выбор), нейтральный", 1),
    ("подменена оговорка", "Large Celestial, Fey, or Fiend (Your Choice), Neutral",
     "Большой Небожитель, Фея или Исчадие (на выбор Мастера), нейтральный", 1),
    ("составной подтип", "Large Fiend (Demon, Shapechanger), Chaotic Evil",
     "Большое Исчадие (демон, перевёртыш), Хаотично-злой", 0),
    ("подменён подтип", "Large Fiend (Demon, Shapechanger), Chaotic Evil",
     "Большое Исчадие (ангел, перевёртыш), Хаотично-злой", 1),
]
# Снимок конвенции главы: 5.1 пишет мировоззрение с прописной. «Unaligned» глава этого
# снимка не знает — на нём проверяется ветка «сверить форму не с чем».
