...
# Файл правила — `verify-import-gates.md`: #320 разрезал правило надвое (чеклист
# переводчику ↔ механика гейтов), и заявление о покрытии уехало во вторую половину. Гейт
# продолжал читать первую и с того момента падал на main — ровно то, от чего он и сторожит,
# только на самом себе.
_RULE = ROOT / ".claude/rules/verify-import-gates.md"
