...
| ❓ | Pathfinder 2e | Paizo | [ORC](https://paizo.com/orclicense) | [Web](https://2e.aonprd.com/); ORC разрешает републикацию и перевод текста правил; источник — ORC-книги Paizo (Player/GM/Monster Core), **не** Archives of Nethys; знак «Pathfinder» и лор/имена Golarion не использовать; наш перевод остаётся открытым под ORC (copyleft) |
| ❓ | Starfinder 2e | Paizo | [ORC](https://paizo.com/orclicense) | [Web](https://2e.aonsrd.com/); как PF2e — ORC разрешает републикацию + перевод; чистый источник — бесплатный SF2 Playtest PDF / SF2 core, не Archives of Nethys; знак «Starfinder» и лор сеттинга исключить |
...
| ❓ | Fate Core / FAE | Evil Hat Productions | CC BY 3.0 | [Web](https://fate-srd.com/), [Markdown](https://github.com/amazingrando/fate-srd-content); CC BY — републикация и перевод разрешены с атрибуцией |
| ❓ | Blades in the Dark | One Seven Design | CC BY 3.0 | [Web](https://bladesinthedark.com/), [Markdown](https://github.com/amazingrando/blades-in-the-dark-srd-content); CC BY — републикация и перевод разрешены с атрибуцией |
| ❓ | Dungeon World | Sage LaTorra | CC BY 3.0 | [Web](https://www.dungeonworldsrd.com/), [GitHub](https://github.com/Sagelt/Dungeon-World); CC BY — републикация и перевод разрешены с атрибуцией |
| ❓ | 13th Age (Archmage Engine) | Pelgrane Press | OGL 1.0a | [Web](https://www.13thagesrd.com/), [PDF](https://pelgranepress.com/media/SRD/13thAgeArchmageEngineSRD.pdf); OGL 1.0a — перевод покрыт определением «Use» §1(h); обязательно приложить текст OGL + строку в Section 15, исключить Product Identity |
