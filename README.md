...
| ❓ | Pathfinder 2e | Paizo | [ORC](https://paizo.com/orclicense) | [Web](https://2e.aonprd.com/); ORC permits republishing and translating the rules text; source from Paizo's ORC-noticed books (Player/GM/Monster Core), **not** Archives of Nethys; exclude the "Pathfinder" mark and Golarion lore/names; our translation stays open under ORC (copyleft) |
| ❓ | Starfinder 2e | Paizo | [ORC](https://paizo.com/orclicense) | [Web](https://2e.aonsrd.com/); same as PF2e — ORC allows republication + translation; clean source is the free SF2 Playtest PDF / SF2 core, not Archives of Nethys; "Starfinder" mark and setting lore excluded |
...
| ❓ | Fate Core / FAE | Evil Hat Productions | CC BY 3.0 | [Web](https://fate-srd.com/), [Markdown](https://github.com/amazingrando/fate-srd-content); CC BY — republication and translation allowed with attribution |
| ❓ | Blades in the Dark | One Seven Design | CC BY 3.0 | [Web](https://bladesinthedark.com/), [Markdown](https://github.com/amazingrando/blades-in-the-dark-srd-content); CC BY — republication and translation allowed with attribution |
| ❓ | Dungeon World | Sage LaTorra | CC BY 3.0 | [Web](https://www.dungeonworldsrd.com/), [GitHub](https://github.com/Sagelt/Dungeon-World); CC BY — republication and translation allowed with attribution |
| ❓ | 13th Age (Archmage Engine) | Pelgrane Press | OGL 1.0a | [Web](https://www.13thagesrd.com/), [PDF](https://pelgranepress.com/media/SRD/13thAgeArchmageEngineSRD.pdf); OGL 1.0a — translation is covered by "Use" §1(h); must ship the OGL text + a Section 15 line and exclude Product Identity |
