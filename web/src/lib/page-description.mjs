...
//   1. вводная проза — абзацы после H1 до первого подзаголовка (есть у большинства глав);
...
/**
 * Вводная проза страницы: абзацы после H1 и ДО первого подзаголовка. Именно вступление,
 * а не «первый попавшийся абзац»: у страниц-справочников (Монстры А–Я, глоссарии) первым
 * абзацем идёт кусок первой же сущности («Large Aberration, Lawful Evil»), и в сниппет
 * он лезть не должен.
 */
