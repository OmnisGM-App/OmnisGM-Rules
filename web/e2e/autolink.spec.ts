...
test('черты: ячейка таблицы класса (Увеличение характеристик) линкуется на страницу черты', async ({ page }) => {
  // Таблица прогрессии воина: «Увеличение характеристик» на уровнях 4/6/… → ссылка на ASI-черту.
  // Курируемый алиас формы (мн.ч. в таблице vs ед.ч. в заголовке) линкует их на ту же сущность.
