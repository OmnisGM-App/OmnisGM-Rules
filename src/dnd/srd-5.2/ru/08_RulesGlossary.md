...
Пассивное восприятие — это значение, отражающее общую осведомлённость существа об окружающей среде. МИ использует это значение при определении, замечает ли существо что-то без сознательного совершения проверки Мудрости (Внимательность).

Пассивное восприятие существа равно 10 плюс бонус проверки Мудрости (Внимательность) существа. Если существо имеет преимущество на такие проверки, увеличьте значение на 5. Если существо имеет помеху на них, уменьшите значение на 5. Например, персонаж 1-го уровня с Мудростью 15 и владением Внимательностьм имеет пассивное восприятие 14 (10 + 2 + 2). Если этот персонаж имеет преимущество на проверки Мудрости (Внимательность), значение становится 19.
