...
Когда вы попадаете по цели, на ней появляются хватающие лозы, и она совершает спасбросок Силы. Большое или большее существо совершает этот спасбросок с преимуществом. При провале цель получает состояние «Опутанный» до окончания заклинания. При успехе лозы увядают, и заклинание заканчивается.
...
> #### Потусторонний скакун (Otherworldly Steed)
>
...
Никто, кроме вас, не видит пса, и он нематериален и неуязвим. Когда Маленькое или большее существо приближается к нему на расстояние 30 футов, не произнеся сначала пароль, который вы указываете при сотворении этого заклинания, пёс начинает громко лаять. У пса есть истинное зрение в радиусе 30 футов.
...
Предметы оживают по вашей команде. Выберите несколько немагических предметов в пределах дистанции, которые не носят и не несут, не прикреплены к поверхности и не являются Громадными. Максимальное количество предметов равно модификатору вашей заклинательной характеристики; для этого числа Средняя или меньшая цель считается одним предметом, Большая цель считается двумя, а Огромная — тремя.
...
**_Использование ячейки более высокого уровня._** Урон Удара существа увеличивается на 1d4 (Среднее или меньшее), 1d6 (Большое) или 1d12 (Огромное) за каждый уровень ячейки выше 5-го.
...
> **КД** 15
>
> **Хиты** 10 (Средний или меньше), 20 (Большой), 40 (Огромный)
>
> **Скорость** 30 фт.
>
> | Характеристика | Значение | Мод. | Спасбросок |
...
> ##### Действия
>
> **_Удар. Атака оружием ближнего боя:_** Бонус равен вашему бонусу атаки заклинанием, досягаемость 5 фт. *Попадание:* Урон силовым полем, равный 1d4 + 3 (Средний или меньше), 2d6 + 3 + модификатор вашей заклинательной характеристики (Большой) или 2d12 + 3 + модификатор вашей заклинательной характеристики (Огромный).
...
При сотворении заклинания выберите, создаёт ли оно антипатию или симпатию, и выберите цель — одно существо или предмет размера Огромный или меньше. Затем укажите вид существ, например красные драконы, гоблины или вампиры. Существо выбранного вида совершает спасбросок Мудрости, когда оказывается в пределах 120 футов от цели. Ваш выбор антипатии или симпатии определяет, что происходит с существом, когда оно проваливает этот спасбросок:
